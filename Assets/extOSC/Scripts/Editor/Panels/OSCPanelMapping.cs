...
namespace extOSC.Editor.Panels
{
    public class OSCPanelMapping : OSCPanel
    {
        ...
        private static readonly GUIContent _addFloatValueContent = new GUIContent("Add Float Value");
        ...
        public OSCPanelMapping(OSCWindow parent, string uniqueName) : base(parent, uniqueName) { }
        ...
        private void DrawMapMessage(OSCMapMessage mapMessage, bool expand)
        {
            ...
            EditorGUILayout.BeginHorizontal("box");
            GUI.color = Color.green;
            var addButton = GUILayout.Button(_addFloatValueContent, GUILayout.Height(EditorGUIUtility.singleLineHeight));
            if (addButton) mapMessage.Values.Add(new OSCMapValue());
            GUI.color = _defaultColor;
            EditorGUILayout.EndHorizontal();
        ...
        private void DrawMapValue(OSCMapValue mapValue, bool expand)
        {
            ...
            GUILayout.Label(mapValue.ValueType + ":");
            EditorGUILayout.EndHorizontal();
