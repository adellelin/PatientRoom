...
{
    public class OSCWindowControlCreator : OSCWindow<OSCWindowControlCreator>
    {
        #region Extensions
        ...
        protected OSCPanelControlCreator mainPanel;
        ...
        {
            mainPanel = new OSCPanelControlCreator(this, "oscControlCreatorPanel");
        ...
        protected override void LoadWindowSettings()
        {
            ...
            mainPanel.ContolColor = OSCEditorSettings.GetColor(_controlColorSettings);
            mainPanel.AddInformer = OSCEditorSettings.GetBool(_addInformerSettings, true);
            mainPanel.InformerAddress = OSCEditorSettings.GetString(_informerAddressSettings, "/address");
            mainPanel.InformOnChanged = OSCEditorSettings.GetBool(_informOnChangedSettings, true);
            mainPanel.InformerInterval = OSCEditorSettings.GetFloat(_informerIntervalSettings, 0f);
            mainPanel.InformerTransmitter = OSCEditorSettings.GetTransmitter(_informerTransmitterSettings);
        }
        ...
        protected override void SaveWindowSettings()
        {
            ...
            OSCEditorSettings.SetColor(_controlColorSettings, mainPanel.ContolColor);
            OSCEditorSettings.SetBool(_addInformerSettings, mainPanel.AddInformer);
            OSCEditorSettings.GetString(_informerAddressSettings, mainPanel.InformerAddress);
            OSCEditorSettings.GetBool(_informOnChangedSettings, mainPanel.InformOnChanged);
            OSCEditorSettings.GetFloat(_informerIntervalSettings, mainPanel.InformerInterval);
            OSCEditorSettings.SetTransmitter(_informerTransmitterSettings, mainPanel.InformerTransmitter);
        }
