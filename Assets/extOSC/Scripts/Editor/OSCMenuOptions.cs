...
public static class OSCMenuOptions
{
    ...
    {
        OSCControls.CreateManager();
    }

    [MenuItem("GameObject/extOSC/Pad", false, 41)]
    ...
    [MenuItem("GameObject/extOSC/Slider", false, 42)]
    ...
    [MenuItem("GameObject/extOSC/Button", false, 43)]
    ...
    [MenuItem("GameObject/extOSC/Rotary", false, 44)]
    ...
    [MenuItem("GameObject/extOSC/Multiply Sliders (Vertical)", false, 45)]
    ...
    [MenuItem("GameObject/extOSC/Multiply Sliders (Horizontal)", false, 46)]
